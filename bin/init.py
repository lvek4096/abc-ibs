...
cur.execute('create table if not exists payment_details(pay_id varchar(5) primary key,bkgid int,amt int,payment_type varchar(20),cardno varchar(16),cardname varchar(50),cvv int(3),exp_month int(2),exp_year int(4))')
