		...
		if not uname.get()=='' and not uname.get().isspace():
			if uname.get() in c:
				...
				if confirm == True:
					...
					messagebox.showinfo('','Employee '+b[uname.get()]+' not deleted. The database\nhas not been modified.',parent=delone_win)
			else:
...
tk.Label(manageempwin,text=('Manage employees'),font=h1fnt).grid(column=1,row=0,sticky=tk.W,padx=10,pady=10)
...
tk.Label(manageempwin,text='View all employee details.',font=fnt,fg='blue').grid(column=1,row=5,padx=10,pady=10,sticky=tk.W)
...
tk.Label(manageempwin,text='View a single employee\'s details.',font=fnt).grid(column=3,row=5,padx=10,pady=10,sticky=tk.W)
...
tk.Label(manageempwin,text='Register an employee.',font=fnt,fg='green').grid(column=1,row=6,padx=10,pady=10,sticky=tk.W)
...
tk.Label(manageempwin,text='Change the password for an employee.',font=fnt).grid(column=3,row=6,padx=10,pady=10,sticky=tk.W)
...
tk.Label(manageempwin,text='Delete an employee.',font=fnt,fg='red').grid(column=1,row=7,padx=10,pady=10,sticky=tk.W)
