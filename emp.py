	...
	def onlogin():	#action on login
		...
		def bus():	#manage bus bookings
			...
			def viewone():	#View one booking
				...
				img=tk.Label(frame1,image=img14,font=hfnt)
				img.grid(column=0,row=0,padx=10,pady=10)
				img.image=img14

				tk.Label(frame1,font=hfnt,text='View bus booking details').grid(row=0,column=1,padx=10,pady=10,sticky=tk.W)
			...
			def delone():	#Delete booking
				...
				img=tk.Label(delone_win,image=img14,font=hfnt)
				img.grid(column=0,row=0,padx=10,pady=10)
				img.image=img14

				tk.Label(delone_win,text='Delete bus booking',font=hfnt).grid(column=1,row=0,padx=10,pady=10,sticky=tk.W)
			...
			himg.image=img6
			tk.Label(f1,text=('Manage the bus booking...'),font=hfnt).grid(column=1,row=0,sticky=tk.W,padx=10,pady=10)
		...
		def taxi():	#Manage taxi bookings
			...
			def viewone():	#View one bookings
				...
				tk.Label(frame1,font=hfnt,text='View taxi booking details...').grid(row=0,column=1,padx=10,pady=10,sticky=tk.W)
			...
			def delone(): #Delete one booking.
				...
				tk.Label(delone_win,text='Delete a taxi booking',font=hfnt).grid(column=1,row=0,padx=10,pady=10,sticky=tk.W)
			...
			himg.grid(column=0,row=0,sticky=tk.E,padx=10,pady=10)
			himg.image=img6
			tk.Label(f1,text=('Manage the taxi booking...'),font=hfnt).grid(column=1,row=0,sticky=tk.W,padx=10,pady=10)
		...
		def payments():	#Manage payment details
			...
			def viewone():	#View single transaction
				...
				tk.Label(frame1,font=hfnt,text='View transaction details...').grid(row=0,column=1,padx=10,pady=10,sticky=tk.W)
			...
			def delone(): #Cancel single transaction.
				...
				tk.Label(delone_win,text='Cancel a transaction',font=hfnt).grid(column=1,row=0,padx=10,pady=10,sticky=tk.W)
			...
			himg.grid(column=0,row=0,sticky=tk.E,padx=10,pady=10)
			himg.image=img6
			tk.Label(f1,text=('Manage transactions...'),font=hfnt).grid(column=1,row=0,sticky=tk.W,padx=10,pady=10)
		...
		def admin():	#Admin menu
			...
			def manage_admin():	#Manage admins
				...
				def viewone():	#View details of administrator
					...
					tk.Label(frame1,font=hfnt,text='View administrator details').grid(row=0,column=1,padx=10,pady=10,sticky=tk.W)
				...
				def delone():	#Deletes an administrator.
					...
					tk.Label(delone_win,text='Delete an administrator...',font=hfnt).grid(column=1,row=0,padx=10,pady=10,sticky=tk.W)
				...
				def passwd():	#Change password for administrator currently logged in
					...
					img=tk.Label(passwd_win,image=img14,font=hfnt)
					img.grid(column=0,row=0,padx=10,pady=10)
					img.image=img14

					tk.Label(passwd_win,text='Change password\nfor administrator...',font=hfnt,justify=tk.LEFT).grid(column=1,row=0,padx=10,pady=10,sticky=tk.W)
				...
				def add():	#Register a new administrator.
					...
					img=tk.Label(reg_win,image=img14,font=hfnt)
					img.grid(column=0,row=0,padx=10,pady=10)
					img.image=img14

					tk.Label(reg_win,text='Register administrator...',font=hfnt).grid(column=1,row=0,sticky=tk.W,padx=10,pady=10)
				...
				himg.grid(column=0,row=0,sticky=tk.E,padx=10,pady=10)
				himg.image=img6
				tk.Label(f1,text=('Manage the administrators...'),font=hfnt).grid(column=1,row=0,sticky=tk.W,padx=10,pady=10)
			...
			def manage_agents():	#Manage agents (employees)
				...
				def viewone():	#Show an agent's info
					...
					tk.Label(frame1,font=hfnt,text='View agent details').grid(row=0,column=1,padx=10,pady=10,sticky=tk.W)
				...
				def delone():	#Delete an agent
					...
					tk.Label(delone_win,text='Delete an agent...',font=hfnt).grid(column=1,row=0,padx=10,pady=10,sticky=tk.W)
				...
				def passwd():	#Change password for agent
					...
					tk.Label(passwd_win,text='Change password\nfor agent...',font=hfnt,justify=tk.LEFT).grid(column=1,row=0,padx=10,pady=10,sticky=tk.W)
				...
				def add():	#Add an agent.
					...
					tk.Label(reg_win,text='Register agent...',font=hfnt).grid(column=1,row=0,sticky=tk.W,padx=10,pady=10)
				...
				himg.grid(column=0,row=0,sticky=tk.E,padx=10,pady=10)
				himg.image=img6
				tk.Label(f1,text=('Manage the agents...'),font=hfnt).grid(column=1,row=0,sticky=tk.W,padx=10,pady=10)
			...
			def manage_users():	#Manage users
				...
				def viewone():	#view single user
					...
					tk.Label(frame1,font=hfnt,text='View user details').grid(row=0,column=1,padx=10,pady=10,sticky=tk.W)
				...
				def delone():	#delete user
					...
					tk.Label(delone_win,text='Delete a user.',font=hfnt).grid(column=1,row=0,padx=10,pady=10,sticky=tk.W)
				...
				def passwd():	#changes password for user
					...
					tk.Label(passwd_win,text='Change password\nfor user',font=hfnt,justify=tk.LEFT).grid(column=1,row=0,padx=10,pady=10,sticky=tk.W)
				...
				def register():	#adds user
					...
					img=tk.Label(reg_win,image=img15,font=hfnt)
					img.grid(column=0,row=0,padx=10,pady=10,sticky=tk.E)
					img.image=img15

					tk.Label(reg_win,text='Add user...',font=hfnt).grid(column=1,row=0,padx=10,pady=10,sticky=tk.W)
				...
				himg=tk.Label(f1,text=('Manage the users...'),font=hfnt)
			...
			def manage_db():	#Manage databases
				...
				def exporttb():		#Export selected table to CSV
					if not table.get()=='' and not table.get().isspace():
						if table.get() in tables_list:
							...
							tk.Label(export_win,font=hfnt,text='Export to CSV file...').grid(row=0,column=0,padx=10,pady=10,sticky=tk.NW)
				...
				def help():		#View help page.
					...
					tk.Label(helpwin,text='What is the difference between\n\'deleting from\' and \'dropping\' a table?',font=hfnt,justify=tk.LEFT).grid(row=0,column=1,padx=10,pady=10,sticky=tk.W)
...
which deletes the table structure from the database along with its contents.'''
				...
				tk.Label(f1,text=('Manage the databases...'),font=hfnt).grid(column=1,row=0,sticky=tk.W,padx=10,pady=10)
			...
			def passwd():
				...
				tk.Label(passwd_win,text='Changing the administrator\npassword for '+a[emp_uname_inp],font=hfnt,justify=tk.LEFT).grid(column=1,row=0,padx=10,pady=10,sticky=tk.W)
			...
			logo=tk.Label(f1,image=logo_img,font=hfnt,fg='white',bg='#1b69bc')
			logo.grid(column=0,row=0,padx=10,pady=10,sticky=tk.EW)
			logo.image=logo_img
			
			tk.Label(f1,text='Welcome, '+a[emp_uname_inp],font=hfnt,justify=tk.CENTER,fg='white',bg='#1b69bc').grid(column=0,row=1,padx=10)
		...
		def empbookings():		#Agent booking menu
			...
			tk.Label(f1,text=txt,fg='white',bg='#1b69bc',font=hfnt,justify=tk.CENTER).grid(column=0,row=1,padx=10,pady=10)
	...
	tk.Label(f1,text='Employee login',font=hfnt,fg='white',bg='#1b69bc').grid(column=0,row=1,padx=10,pady=10,sticky=tk.EW)
